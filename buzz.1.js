...
userAddress = "";
var userLat = "32.8070976";
var userLng = "-96.64596089";
var barLat = "32.8368102";
var barLng = "-96.7774467";

var uberURL = "https://cors-anywhere.herokuapp.com/https://api.uber.com/v1.2/estimates/price?start_latitude=" + userLat + "&start_longitude=" + userLng + "&end_latitude=" + barLat + "&end_longitude=" + barLng;
var uberAuth = "JA.VUNmGAAAAAAAEgASAAAABwAIAAwAAAAAAAAAEgAAAAAAAAG8AAAAFAAAAAAADgAQAAQAAAAIAAwAAAAOAAAAkAAAABwAAAAEAAAAEAAAABpGg-51QEZ8EHAiodL3YIhsAAAAL-iyVo5k0UELpA9d_GrHIrh-1SIJliQXRFob4LRgAG8bnETC2jFSU8XZ8Yt5j0dResiOKBiB8P_FUxoUmfsWZFNa9UVRWcwboCZE3Pg1RSNMTUJPn8uSJWxPXhY6y_WY4Vu5U5hkLiFwWPMPDAAAAAYqxrsv0HOtXEF7viQAAABiMGQ4NTgwMy0zOGEwLTQyYjMtODA2ZS03YTRjZjhlMTk2ZWU";
...
function callUber() {
  $.ajax({
    ...
    console.log("Duration: " + response.prices[0].duration);
    console.log("-----------------");
    console.log("Type: " + response.prices[0].display_name);
    console.log("Fee Estimate: " + response.prices[0].estimate);
    console.log("Type: " + response.prices[1].display_name);
    console.log("Fee Estimate: " + response.prices[1].estimate);
    console.log("Type: " + response.prices[2].display_name);
    console.log("Fee Estimate: " + response.prices[2].estimate);
    console.log("Type: " + response.prices[3].display_name);
    console.log("Fee Estimate: " + response.prices[3].estimate);
    console.log("Type: " + response.prices[4].display_name);
    console.log("Fee Estimate: " + response.prices[4].estimate);
  })
}
...
// ! This functiongets the user's Lat and Long via the Google Geocode API using an Axios Call
