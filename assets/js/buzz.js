...
var nameArray = ["place 1", "somewhere", "somewhere else"];
var latArray = [32.797867, 32.78948, 32.78871];
var lngArray = [-96.798463, -96.80563, -96.80937];
    ...
    success: function (data) {
      ...
      function barButton() {
        for (var i = 0; i < searchLimit; i++) {
          ...
          nameArray.push(data.businesses[i].name);
